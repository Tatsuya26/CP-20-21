...
\\
\>[B]{}\Varid{outExpAr}\;(\Conid{Un}\;\Varid{op}\;(\Varid{exp}))\mathrel{=}i_2\;(i_2\;\overline{i_2}\;\Varid{op}\;\Varid{exp}){}\<[E]%
\\
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{X}\times(\Conid{ExpAr}\;\Varid{a}\times\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{Y}\times\Conid{ExpAr}\;\Varid{a}}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{g\char95 eval\char95 exp})}}
\\
     \ensuremath{\Varid{a}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}(\Conid{X}\times(\Varid{a}\times\Varid{a}))\mathbin{+}(\Conid{Y}\times\Varid{a})}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{g\char95 eval\char95 exp}\;\Varid{a}\mathrel{=}\alt{\underline{\Varid{a}}}{\alt{\Varid{id}}{\alt{\Varid{binOp}}{\Varid{unOp}}}}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{binOp}\;(\Conid{Sum},(\Varid{e},\Varid{d}))\mathrel{=}\Varid{e}\mathbin{+}\Varid{d}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{binOp}\;(\Conid{Product},(\Varid{e},\Varid{d}))\mathrel{=}\Varid{e}\mathbin{*}\Varid{d}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{unOp}\;{}\<[23]%
\>[23]{}(\Conid{Negate},\Varid{n})\mathrel{=}{}\<[37]%
\>[37]{}\Varid{n}\mathbin{*}(\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{unOp}\;{}\<[23]%
\>[23]{}(\Conid{E},\Varid{n})\mathrel{=}\Varid{\Conid{Prelude}.exp}\;\Varid{n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{X}\times(\Conid{ExpAr}\;\Varid{a}\times\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{Y}\times\Conid{ExpAr}\;\Varid{a}}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{clean})}}
\\
     \ensuremath{\Conid{ExpAr}\;\Varid{a}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{X}\times(\Conid{ExpAr}\;\Varid{a}\times\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{Y}\times\Conid{ExpAr}\;\Varid{a}}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Sum}\;(\Varid{exp1})\;(\Varid{exp2})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{exp1}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{clean}\;\Varid{exp2}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{exp2}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}\Varid{clean}\;\Varid{exp1}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Conid{Product}\;(\Varid{exp1})\;(\Varid{exp2})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{exp1}\equiv (\Conid{N}\;\mathrm{0})\mathrel{\vee}\Varid{exp2}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}i_2\;(i_1\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{exp1}\equiv (\Conid{N}\;\mathrm{1})\mathrel{=}\Varid{clean}\;\Varid{exp2}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{exp2}\equiv (\Conid{N}\;\mathrm{1})\mathrel{=}\Varid{clean}\;\Varid{exp1}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Conid{E}\;\Varid{exp}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{exp}\equiv (\Conid{N}\;\mathrm{0})\mathrel{=}i_2\;(i_1\;\mathrm{1}){}\<[E]%
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{ExpAr}\;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{cataExprAr}\;\Varid{gopt}}}
           \ar[r]_-{\ensuremath{\Varid{outExpAr}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}\Conid{X}\times(\Conid{ExpAr}\;\Varid{a}\times\Conid{ExpAr}\;\Varid{a})\mathbin{+}\Conid{Y}\times\Conid{ExpAr}\;\Varid{a}}
           \ar[d]^{\ensuremath{\Varid{recExpAr}\;(\Varid{gopt})}}
\\
     \ensuremath{\Varid{a}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\mathbin{+}(\Conid{X}\times(\Varid{a}\times\Varid{a}))\mathbin{+}(\Conid{Y}\times\Varid{a})}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sd\char95 gen}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow ()+(\Varid{a}+((\Conid{BinOp},((\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}),(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a})))+(\Conid{UnOp},(\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}))))\to (\Conid{ExpAr}\;\Varid{a},\Conid{ExpAr}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}\alt{\Varid{handleX}}{\alt{\Varid{handleN}}{\alt{\Varid{handleBin}}{\Varid{handleUn}}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{handleX}\;()\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleN}\;\Varid{n}\mathrel{=}(\Conid{N}\;\Varid{n},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleBin}\;(\Conid{Sum},((e_1 ,\Varid{d1}),(e_2 ,\Varid{d2})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;e_1 \;e_2 ,\Conid{Bin}\;\Conid{Sum}\;\Varid{d1}\;\Varid{d2}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleBin}\;(\Conid{Product},((e_1 ,\Varid{d1}),(e_2 ,\Varid{d2})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;e_1 \;e_2 ,\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;e_1 \;\Varid{d2})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{d1}\;e_2 )){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleUn}\;(\Conid{Negate},(e_1 ,\Varid{d1}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;e_1 ,\Conid{Un}\;\Conid{Negate}\;\Varid{d1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleUn}\;(\Conid{E},(e_1 ,\Varid{d1}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;e_1 ,\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;e_1 )\;\Varid{d1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}\mathrel{=}\alt{\Varid{handleX}}{\alt{\Varid{handleN}}{\alt{\Varid{handleBin}\;\Varid{a}}{\Varid{handleUn}\;\Varid{a}}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{handleX}\;()\mathrel{=}(\Conid{X},\mathrm{1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleN}\mathrel{=}\conj{\Conid{N}}{\underline{\mathrm{0}}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleBin}\;\Varid{a}\;(\Conid{Sum},((e_1 ,\Varid{d1}),(e_2 ,\Varid{d2})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;e_1 \;e_2 ,\Varid{d1}\mathbin{+}\Varid{d2}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleBin}\;\Varid{a}\;(\Conid{Product},((e_1 ,\Varid{d1}),(e_2 ,\Varid{d2})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;e_1 \;e_2 ,((\Varid{eval\char95 exp}\;\Varid{a}\;e_1 )\mathbin{*}\Varid{d2})\mathbin{+}((\Varid{eval\char95 exp}\;\Varid{a}\;e_2 )\mathbin{*}\Varid{d1})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleUn}\;\Varid{a}\;(\Conid{Negate},(e_1 ,\Varid{d1}))\mathrel{=}(\Conid{Un}\;\Conid{Negate}\;e_1 ,\Varid{negate}\;\Varid{d1}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{handleUn}\;\Varid{a}\;(\Conid{E},(e_1 ,\Varid{d1}))\mathrel{=}(\Conid{Un}\;\Conid{E}\;e_1 ,\Varid{d1}\mathbin{*}(\Varid{eval\char95 exp}\;\Varid{a}\;(\Conid{Un}\;\Conid{E}\;e_1 ))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{catNumber}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{catNumber}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}((\mathrm{4}\mathbin{*}(\Varid{mysucc}\;(\Varid{n})\mathbin{-}\mathrm{1}))\mathbin{+}\mathrm{2})\mathbin{*}\Varid{catNumber}\;\Varid{n}\div \Varid{mysucc}\;(\Varid{n})\mathbin{+}\mathrm{1}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mysucc}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{mysucc}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{mysucc}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{inic}\mathrel{=}(\mathrm{1},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{loop}\;(\Varid{f},\Varid{mysucc})\mathrel{=}(((\mathrm{4}\mathbin{*}(\Varid{mysucc}\mathbin{-}\mathrm{1}))\mathbin{+}\mathrm{2})\mathbin{*}\Varid{f}\div \Varid{mysucc}\mathbin{+}\mathrm{1},\mathrm{1}\mathbin{+}\Varid{mysucc}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{prj}\;(\Varid{f},\Varid{n})\mathrel{=}\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
    \ensuremath{\begin{lcbr}\Varid{calcLine}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\underline{\Varid{nil}}\\\Varid{calcLine}\;(\Varid{p}\mathbin{:}\Varid{x})\mathrel{=}\uncurry{\Varid{g}}\;\Varid{p}\;(\Varid{calcLine}\;\Varid{x})\end{lcbr}}
%
\just\equiv{ def-nil,def-cons, remover variaveis }
%
    \ensuremath{\begin{lcbr}\Varid{calcLine}\comp \Varid{nil}\mathrel{=}\underline{\Varid{nil}}\\\Varid{calcLine}\comp \Varid{cons}\mathrel{=}\Varid{g}\comp (\Varid{id}\times\Varid{calcLine})\end{lcbr}}
%
\just\equiv{Eq-+,Fusao-+,def-in}
%
    \ensuremath{\Varid{calcLine}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{nil}},\Varid{g}\comp (\Varid{id}\times\Varid{calcLine})\mskip1.5mu]}
%
\just\equiv{Absorçao-+}
%
    \ensuremath{\Varid{calcLine}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{nil}},\Varid{g}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{calcLine})}
%
\just\equiv{Universal-cata}
%
    \ensuremath{\Varid{calcLine}\mathrel{=}\Varid{cataList}\;([\mskip1.5mu \underline{\Varid{nil}},\Varid{g}\mskip1.5mu])}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\;(i_1\;\Varid{a})\mathrel{=}\underline{\Varid{nil}}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{h}\;(i_2\;(\Varid{a},\Varid{x}))\mathrel{=}\Varid{g}\;(\Varid{a},\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{NPoint}\mathbin{*}}
           \ar[d]_-{\ensuremath{\Varid{anaBTree}\;(\Varid{divide}\comp \Varid{outList})}}
           \ar[r]_-{\ensuremath{\Varid{divide}\comp \Varid{outList}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{NPoint}\times(\Conid{NPoint}\mathbin{*}\times\Conid{NPoint}\mathbin{*})}
           \ar[d]^{\ensuremath{\Varid{recBTree}\;(\Varid{divide}\comp \Varid{outList})}}
\\
     \ensuremath{\fun{BTree} \;\Conid{NPoint}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{NPoint}\times(\fun{BTree} \;\Conid{NPoint}\times\fun{BTree} \;\Conid{NPoint})}
           \ar[l]^-{\ensuremath{\Varid{inBTree}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\fun{BTree} \;\Conid{NPoint}}
           \ar[d]_-{\ensuremath{\Varid{cataBTree}\;\Varid{calc}}}
           \ar[r]_-{\ensuremath{\Varid{outBTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{NPoint}\times(\fun{BTree} \;\Conid{NPoint}\times\fun{BTree} \;\Conid{NPoint})}
           \ar[d]^{\ensuremath{\Varid{recBTree}\;(\Varid{cataBTree}\;\Varid{calc})}}
\\
     \ensuremath{\Conid{NPoint}\to \Conid{Overtime}\;\Conid{NPoint}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{NPoint}\times(\Conid{Overtime}\;\Conid{NPoint}\times\Conid{Overtime}\;\Conid{NPoint})}
           \ar[l]^-{\ensuremath{\Varid{calc}}}
}
\end{eqnarray*}
...
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\mathrel{=}\Varid{hyloAlgForm}\;\Varid{alg}\;\Varid{coalg}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{coalg}\mathrel{=}\Varid{anaBTree}\;(\Varid{divide}\comp \Varid{outList}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{divide}\;(i_1\;\Varid{a})\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{divide}\;(i_2\;(\Varid{a},\Varid{l}))\mathrel{=}i_2\;(\Varid{a},(\Varid{init}\;(\Varid{cons}\;(\Varid{a},\Varid{l})),\Varid{tail}\;(\Varid{cons}\;(\Varid{a},\Varid{l})))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{alg}\mathrel{=}\Varid{cataBTree}\;(\Varid{calc}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{calc}\;(i_1\;\Varid{a})\mathrel{=}\Varid{nil}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{calc}\;(i_2\;(\Varid{a},(\Varid{o1},\Varid{o2})))\mathrel{=}\lambda \Varid{pt}\to (\Varid{calcLine}\;(\Varid{o1}\;\Varid{pt})\;(\Varid{o2}\;\Varid{pt}))\;\Varid{pt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloAlgForm}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{f}\comp \Varid{g}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times\Conid{Double})}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{zero},\Varid{g2}\mskip1.5mu]}}
}
\end{eqnarray*}
...
\\
     \ensuremath{\N_0}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times\N_0))}
           \ar[l]^-{[zero, succ . p2]}
}
\end{eqnarray*}

Assim, para calcular a média, temos um split de catamorfismos (\ensuremath{\Varid{avg\char95 aux}\mathrel{=}\conj{\Varid{avg}}{\length }}) e no final basta retirar o valor que queremos
...
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times\Conid{A}\mathbin{*})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\mathbin{+}\Varid{avg\char95 aux})}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{(\Conid{Double}\times\N_0)}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\Conid{Double}\times\N_0))}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{init},\Varid{work}\mskip1.5mu]}}
}
\end{eqnarray*}
...
\begin{eqnarray*}
\start
  \ensuremath{\Varid{init}\mathrel{=}\conj{\Varid{zero}}{\Varid{zero}}}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
  \ensuremath{\length \;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}\Varid{l}\mathbin{+}\mathrm{1}}
%
\just\equiv{ def. succ, def. p2 }
%
  \ensuremath{\length \;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}\succ \comp \p2\comp \p2\;(\Varid{a},(\Varid{avg},\Varid{l})}
\just\equiv{ igualdade extensional }
%
  \ensuremath{\length \mathrel{=}\succ \comp \p2\comp \p2}
\qed
\end{eqnarray*}

\begin{eqnarray*}
\start
  \ensuremath{\Varid{new\char95 avg}\;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{l}\mathbin{*}\Varid{avg})\mathbin{/}(\Varid{l}\mathbin{+}\mathrm{1})}
%
\just\equiv{ def. succ, def. uncurry }
%
  \ensuremath{\Varid{new\char95 avg}\;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}\uncurry{(\mathbin{/})}\;(\Varid{a}\mathbin{+}\Varid{l}\mathbin{*}\Varid{avg},\succ \;\Varid{l})}
\just\equiv{ def. uncurry, def \ensuremath{\times} }
%
  \ensuremath{\Varid{new\char95 avg}\;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\succ )\;((\Varid{a},\Varid{l}\mathbin{*}\Varid{avg}),\Varid{l})}
\just\equiv{ def split, def. id, def. uncurry, def. p2 }
%
  \ensuremath{\Varid{new\char95 avg}\;(\Varid{a},(\Varid{avg},\Varid{l}))\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\succ )\comp \conj{\Varid{id}\times\uncurry{(\mathbin{*})}}{\p2\comp \p2}\;(\Varid{a},(\Varid{avg},\Varid{l}))}
\just\equiv{ igualdade extensional }
%
  \ensuremath{\Varid{new\char95 avg}\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\succ )\comp \conj{\Varid{id}\times\uncurry{(\mathbin{*})}}{\p2\comp \p2}}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{gene}\mathrel{=}\alt{\Varid{init}}{\Varid{work}}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{init}\mathrel{=}\conj{\underline{\mathrm{0}}}{\underline{\mathrm{0}}}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{work}\mathrel{=}\conj{\Varid{new\char95 avg}}{\length }{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\Varid{new\char95 avg}\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\succ )\comp \conj{\Varid{id}\times\uncurry{(\mathbin{*})}}{\p2\comp \p2}{}\<[E]%
\\
\>[11]{}\hsindent{6}{}\<[17]%
\>[17]{}\length \mathrel{=}\succ \comp \p2\comp \p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{avg\char95 aux}\mathbin{+}\Varid{avg\char95 aux})}}
           \ar[l]_-{\ensuremath{\mathsf{in}}}
\\
     \ensuremath{(\Conid{Double}\times\N_0)}
&
     \ensuremath{\Conid{A}\mathbin{+}((\Conid{Double}\times\N_0)\times(\Conid{Double}\times\N_0))}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{init},\Varid{work}\mskip1.5mu]}}
}
\end{eqnarray*}

\begin{eqnarray*}
\ensuremath{\Varid{avg\char95 aux}\mathrel{=}\llparenthesis\, [\mskip1.5mu \Varid{init},\Varid{work}\mskip1.5mu]\,\rrparenthesis}
\end{eqnarray*}
...
\begin{eqnarray*}
\start
  \ensuremath{\Varid{init}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1}}})}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
  \ensuremath{\Varid{contaNodos}\;((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\Varid{l1}\mathbin{+}\Varid{l2}}
%
\just\equiv{ def. uncurry }
%
  \ensuremath{\Varid{contaNodos}\;((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\uncurry{(\mathbin{+})}\;(\Varid{l1},\Varid{l2}))}
\just\equiv{ def. split, def. p1, def. p2 }
%
  \ensuremath{\Varid{contaNodos}\;((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\uncurry{(\mathbin{+})}\comp \conj{\p2\comp \p1}{\p2\comp \p2}\;((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))}
\just\equiv{ igualdade extensional }
%
  \ensuremath{\Varid{contaNodos}\mathrel{=}\uncurry{(\mathbin{+})}\comp \conj{\p2\comp \p1}{\p2\comp \p2}}
\qed
\end{eqnarray*}

\begin{eqnarray*}
\start
  \ensuremath{\Varid{new\char95 avg}\;(((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}((\Varid{a1}\mathbin{*}\Varid{l1})\mathbin{+}(\Varid{a2}\mathbin{*}\Varid{l2}))\mathbin{/}(\Varid{l1}\mathbin{+}\Varid{l2})}
%
\just\equiv{ def. uncurry }
%
  \ensuremath{\Varid{new\char95 avg}\;(((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\uncurry{(\mathbin{/})}\;((\Varid{a1}\mathbin{*}\Varid{l1})\mathbin{+}(\Varid{a2}\mathbin{*}\Varid{l2}),\Varid{l1}\mathbin{+}\Varid{l2})}
\just\equiv{ def. uncurry, def. >< }
%
  \ensuremath{\Varid{new\char95 avg}\;(((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\;((\Varid{a1}\mathbin{*}\Varid{l1},\Varid{a2}\mathbin{*}\Varid{l2}),(\Varid{l1},\Varid{l2}))}
\just\equiv{ def. ><, def. uncurry, def. id }
%
\ensuremath{\Varid{new\char95 avg}\;(((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp ((\uncurry{(\mathbin{*})}\times\uncurry{(\mathbin{*})})\times(\Varid{id}\times\Varid{id}))\;(((\Varid{a1},\Varid{l2}),(\Varid{a1},\Varid{l2})),(\Varid{l1},\Varid{l2}))}
  \just\equiv{ def. split, def. id, def. uncurry, def. p2 }
%
  \ensuremath{\Varid{new\char95 avg}\;(((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp ((\uncurry{(\mathbin{*})}\times\uncurry{(\mathbin{*})})\times(\Varid{id}\times\Varid{id}))\comp \conj{\Varid{id}}{\p2\times\p2}\;(((\Varid{a1},\Varid{l1}),(\Varid{a2},\Varid{l2}))}
\just\equiv{ igualdade extensional }
%
  \ensuremath{\Varid{new\char95 avg}\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp ((\uncurry{(\mathbin{*})}\times\uncurry{(\mathbin{*})})\times(\Varid{id}\times\Varid{id}))\comp \conj{\Varid{id}}{\p2\times\p2}}
\just\equiv{ absorção \ensuremath{\times}, natural id }
%
  \ensuremath{\Varid{new\char95 avg}\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp \conj{\uncurry{(\mathbin{*})}\times\uncurry{(\mathbin{*})}}{(\Varid{id}\times\Varid{id})\comp (\p2\times\p2)}}
\just\equiv{ functor \ensuremath{\times}, natural id }
%
  \ensuremath{\Varid{new\char95 avg}\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp \conj{\uncurry{(\mathbin{*})}\times\uncurry{(\mathbin{*})}}{\p2\times\p2}}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\mathbf{where}\;\Varid{gene}\mathrel{=}\alt{\Varid{init}}{\Varid{work}}{}\<[E]%
\\
\>[12]{}\hsindent{6}{}\<[18]%
\>[18]{}\Varid{init}\mathrel{=}\conj{\Varid{id}}{\underline{\mathrm{1}}}{}\<[E]%
\\
\>[12]{}\hsindent{6}{}\<[18]%
\>[18]{}\Varid{work}\mathrel{=}\conj{\Varid{new\char95 avg}}{\Varid{contaNodos}}{}\<[E]%
\\
\>[12]{}\hsindent{6}{}\<[18]%
\>[18]{}\Varid{new\char95 avg}\mathrel{=}\uncurry{(\mathbin{/})}\comp (\uncurry{(\mathbin{+})}\times\uncurry{(\mathbin{+})})\comp \conj{\uncurry{(\mathbin{*})}\times\uncurry{(\mathbin{*})}}{\p2\times\p2}{}\<[E]%
\\
\>[12]{}\hsindent{6}{}\<[18]%
\>[18]{}\Varid{contaNodos}\mathrel{=}\uncurry{(\mathbin{+})}\comp \conj{\p2\comp \p1}{\p2\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
